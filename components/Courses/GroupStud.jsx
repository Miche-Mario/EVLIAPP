    ...
    return (
        ...
        <div className='mt-3'>
            <div className='ml-4 mb-4'>
                <span className='text-base '> Selcted Course </span> <span className='p-2 text-white text-xl w-auto bg-dark-purple rounded'>General English</span>
            </div>
