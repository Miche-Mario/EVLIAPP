            ...
            <div className="bg-white  w-full ">
                    ...
                    <Box sx={style} >
                        ...
                        <form>
                            <div className='flex flex-row m-3 justify-around items-center'>
                                <div className=''>
                                    <label for="first_name" class="block mb-6 text-base font-medium text-gray-900 p-1 ">Payment date</label>
                                    <label for="first_name" class="block mb-5 text-base font-medium text-gray-900 p-1 ">Payment Info</label>
                                    <label for="first_name" class="block mb-5 text-base font-medium text-gray-900 p-1 ">Payment Method</label>
                                ...
                                <input type="date" id="first_name" class="bg-gray-50 border mb-4 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-60 p-2 " placeholder="enrollement date" required />
                                    ...
                                    <select id="countries" class="bg-gray-50 mb-4  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                        <option></option>
                                        <option value="US">Full Price</option>
                                        <option value="CA">Tee-Shirt</option>
                                    </select>
                                    <select id="countries" class="bg-gray-50 mb-4  border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                        <option></option>
                                        <option value="US">Cash</option>
                                        <option value="CA">Visa Card</option>
                                    </select>
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="bg-gray-200  text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th className=" py-3 px-3 text-center">Installment</th>
                        ...
                        <tbody className="text-gray-600  text-sm font-light">
                            <tr className="border-b border-gray-200  hover:bg-gray-100">
                                ...
                                <td className="p-0">
                                    <div className="flex items-center justify-center">
                                        <span className="font-medium uppercase">03 Juin 2022</span>
                                    </div>
                                </td>
                                ...
                                <td className=" py-3 px-3 text-center">
                                    <div className="flex items-center justify-center">
                                        <span className="font-medium">03 Juin 2022</span>
                                    </div>
                                </td>
                                <td className=" py-3 px-3 text-center">
                                    <div className="flex items-center justify-center">
                ...
                <div>
                    <div className='flex flex-row justify-end'>
                        <div className='flex flex-row m-3 justify-around items-center'>
                            <div className=''>
                                <label for="first_name" class="block mb-6 mr-4 text-sm mt-3 font-medium text-gray-900 p-1 ">Total</label>
                                <label for="first_name" class="block mb-5 mr-4 text-sm font-medium text-gray-900 p-1 ">Price</label>
                                <label for="first_name" class="block mb-5 mr-4 text-sm font-medium text-gray-900 p-1 ">Debt</label>
                            ...
                            <input type="text" id="first_name" class="bg-gray-50 border text-right mb-4 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-48 p-2 " placeholder="22" required />
                            <input type="text" id="first_name" class="bg-gray-50 border text-right  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-48 p-2 " placeholder="22" required />
                ...
                <div className='flex flex-row mr-2 justify-end mt-3 mb-3 '>
